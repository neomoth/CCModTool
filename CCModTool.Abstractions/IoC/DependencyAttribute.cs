...
/// </summary>
/// <remarks>
///	This currently only really exists for the logger, but it's also an exercise to learn how dependency injection works.
/// <para>
...
/// and as a matter of fact it is recommended to do so.
/// </para>
/// <para>
/// If you would like to run code after dependencies have been injected, use <see cref="IPostInjectInit"/>
/// </para>
/// </remarks>
