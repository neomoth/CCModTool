...
public interface IDependencyCollection
{
	...
	/// <summary>
	/// Registers an interface to an implementation, to make it accessible to <see cref="IDependencyCollection.Resolve{T}()"/>
	...
	/// or if an already instantiated interface (by <see cref="IDependencyCollection.BuildGraph"/>) is attempting to be overwritten.
	/// </exception>
	...
	/// or if an already instantiated interface (by <see cref="IDependencyCollection.BuildGraph"/>) is attempting to be overwritten.
	/// </exception>
	void Register<TInterface, TImplementation>(DependencyFactoryDelegate<TImplementation> factory,
	...
	void Resolve<T>([System.Diagnostics.CodeAnalysis.NotNull] ref T? instance);

	/// <inheritdoc cref="Resolve{T}(ref T?)"/>
	/// <summary>
	/// Resolve two dependencies manually.
	/// </summary>
	void Resolve<T1, T2>([System.Diagnostics.CodeAnalysis.NotNull] ref T1? instance1,
		[System.Diagnostics.CodeAnalysis.NotNull] ref T2? instance2);

	/// <inheritdoc cref="Resolve{T1, T2}(ref T1?, ref T2?)"/>
	/// <summary>
	/// Resolve three dependencies manually.
	/// </summary>
	void Resolve<T1, T2, T3>([System.Diagnostics.CodeAnalysis.NotNull] ref T1? instance1,
		[System.Diagnostics.CodeAnalysis.NotNull] ref T2? instance2,
	...
	/// </summary>
	void Resolve<T1, T2, T3, T4>([System.Diagnostics.CodeAnalysis.NotNull] ref T1? instance1,
		[System.Diagnostics.CodeAnalysis.NotNull] ref T2? instance2,
		[System.Diagnostics.CodeAnalysis.NotNull] ref T3? instance3,
		[System.Diagnostics.CodeAnalysis.NotNull] ref T4? instance4);
	...
	/// </summary>
	/// <seealso cref="IDependencyCollection.InjectDependencies"/>
	void BuildGraph();
	...
	/// </exception>
	/// <seealso cref="IDependencyCollection.BuildGraph"/>
